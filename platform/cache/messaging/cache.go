...
var messageCodeToHTTPStatus = map[string]int{
	...
	"MOD_U_DUP_ERR_00001":        http.StatusConflict,     // 409 - Usuario duplicado (email)
	"MOD_U_DUP_IDNUM_ERR_00013":  http.StatusConflict,     // 409 - Número de identificación duplicado
