...
const (
	...
	LogAppCORSConfigured    = "CORS middleware configured"
)
...
// ============================================
const (
	LogEmployeeServiceEmailExtracted            = "Email extracted from token"
...
const (
	...
	LogAirlineRepoUpdateStatusStart    = "UpdateAirlineStatus: Starting update"
	LogAirlineRepoUpdateStatusNotFound = "UpdateAirlineStatus: Airline not found"
	LogAirlineRepoUpdateStatusOK       = "UpdateAirlineStatus: Status updated successfully (idempotent)"
)
...
const (
	...
	LogAirlineEmployeeRepoAddStart         = "AddAirlineEmployee: Starting add"
	LogAirlineEmployeeRepoAddQueryOK       = "AddAirlineEmployee: Query executed successfully"
	LogAirlineEmployeeRepoUpdateStart      = "UpdateAirlineEmployee: Starting update"
	LogAirlineEmployeeRepoUpdateQueryOK    = "UpdateAirlineEmployee: Query executed successfully"
	LogAirlineEmployeeRepoStatusStart      = "UpdateAirlineEmployeeStatus: Starting update"
	LogAirlineEmployeeRepoStatusNotFound   = "UpdateAirlineEmployeeStatus: employee not found"
	LogAirlineEmployeeRepoStatusNoInfo     = "UpdateAirlineEmployeeStatus: Employee has no airline info assigned"
	LogAirlineEmployeeRepoStatusUpdateFail = "UpdateAirlineEmployeeStatus: update failed"
	LogAirlineEmployeeRepoStatusOK         = "UpdateAirlineEmployeeStatus: Status updated successfully (idempotent)"
	LogAirlineEmployeeServiceGetError      = "GetAirlineEmployeeByID: error"
)
