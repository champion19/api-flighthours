...
import (
	...
	// blank import to register Swagger documentation generated by swaggo
...
func routing(app *gin.Engine, dependencies *dependency.Dependencies) {
	...
	protected.GET(routeEmployees, handler.GetEmployee())
	...
	pilot.Use(middleware.RequireRole("pilot"))
	{
		...
		pilot.PUT(routeEmployees, validator.WithValidateUpdateEmployee(), handler.UpdateEmployee())
		pilot.DELETE(routeEmployees, handler.DeleteEmployee())
