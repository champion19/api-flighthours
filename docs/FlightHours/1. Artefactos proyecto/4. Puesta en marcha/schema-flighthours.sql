...
CREATE TABLE `daily_logbook_detail` (
  ...
  `approach_category` enum('RNP','ILS','VISUAL') DEFAULT NULL,
  `approach_subtype` enum('LNAV','LNAV/VNAV','RNP AR = 0.3','RNP AR < 0.3','CAT I','CAT II','CAT III > 175','CAT III < 175') DEFAULT NULL,
  `autoland` tinyint(1) DEFAULT NULL,
