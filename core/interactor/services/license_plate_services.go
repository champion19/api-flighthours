...
func (s *LicensePlateService) GetLicensePlateByPlate(ctx context.Context, plate string) (*domain.LicensePlate, error) {
	return s.repo.GetLicensePlateByPlate(ctx, plate)
}
